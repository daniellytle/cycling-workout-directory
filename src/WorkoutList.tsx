...
const WorkoutList: React.FC = () => {
  ...
  useEffect(() => {
    resizeList()
    window.onscroll = resizeList
  }, [])

  useEffect(resizeList, [filteredWorkouts])
            ...
            <span
              ...
              className={
                ...
                (selectedTags.includes(tag)
                  ? "ring-blue-500/10 bg-blue-50 text-blue-600"
